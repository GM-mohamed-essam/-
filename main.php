/*
تم نشر الملف  بسورس ايما من قبل المطور بوروتو المصري

channel : @em6mabot
Developer : B_0_R_U
#༒ΜΘЅƬΔFΔ ЅY℞IΔN ☬
هذا الملف هدية بمناسبة شهر رمضان تاريخ نشر الملف 2019/5/19
*/
<?php
ob_start();
error_reporting(0);
define('API_KEY','7315832116:AAEByOztQ3xreK4UImQlBtGYGNfJUUamPtk');
...
$Dev = array("5414068478","6354137184","7162066098"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "DKR6bot"; //UserName Bot
@$channel = "em6mabot"; // UserName Channel don't @
@$token = API_KEY;
...
'inline_keyboard'=>[
[
['text'=>"تابع جديدنا",'url'=>"https://t.me/em6mabot"],['text'=>"$dataadd",'callback_data'=>"text"]
],
]
])
]); 
...
'inline_keyboard'=>[
 	[
['text'=>"📢 تابع جديدنا 📢",'url'=>"https://t.me/em6mabot"]
  ],
   ]
   ])
 ]); 
